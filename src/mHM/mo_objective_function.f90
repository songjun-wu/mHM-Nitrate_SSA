...
CONTAINS
  ...
  FUNCTION objective(parameterset, parameterset_SSA)
    ...
    case (10)
       ...
       objective = objective_sm_kge_catchment_avg(parameterset, parameterset_SSA)
    case (11)
       ! pattern dissimilarity (PD) of SM fields
       objective = objective_sm_pd(parameterset, parameterset_SSA)
    case (12)
       ! sum of squared errors of standard_score SM
       objective = objective_sm_sse_standard_score(parameterset, parameterset_SSA)
    case (13)
       ! soil moisture correlation - temporal
       objective = objective_sm_corr(parameterset, parameterset_SSA)
    case (15)
       ! KGE for Q * RMSE for basin_avg TWS (standarized scored)
       objective = objective_kge_q_rmse_tws(parameterset, parameterset_SSA)
   case (17)
      ! KGE of catchment average SM
      objective = objective_neutrons_kge_catchment_avg(parameterset, parameterset_SSA)
    case default
  ...
  FUNCTION objective_sm_kge_catchment_avg(parameterset, parameterset_SSA)
    ...
    call mhm_eval(parameterset, parameterset_SSA, sm_opti=sm_opti)
  ...
  FUNCTION objective_sm_corr(parameterset, parameterset_SSA)
  ...
  FUNCTION objective_sm_pd(parameterset, parameterset_SSA)
  ...
  FUNCTION objective_sm_sse_standard_score(parameterset, parameterset_SSA)
  ...
  FUNCTION objective_kge_q_rmse_tws(parameterset, parameterset_SSA)
    ...
    call mHM_eval(parameterset, parameterset_SSA, runoff=runoff, basin_avg_tws=tws)
  ...
  FUNCTION objective_neutrons_kge_catchment_avg(parameterset, parameterset_SSA)
    ...
    call mhm_eval(parameterset, parameterset_SSA, neutrons_opti=neutrons_opti)
