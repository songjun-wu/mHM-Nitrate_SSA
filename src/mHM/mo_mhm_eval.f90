...
CONTAINS
  ...
  SUBROUTINE mhm_eval(parameterset, parameterset_SSA, runoff, sm_opti, basin_avg_tws, neutrons_opti,nutrient)
    ...
    do ii = 1, nBasins
       ...
       do tt = 1, nTimeSteps
          ...
          call mhm(perform_mpr, read_restart, fracSealed_cityArea,                          & ! IN C
               ...
               iFlag_soilDB,                                                                & ! IN C
               parameterset, parameterset_SSA(185*0+1:185*6),                                     & ! IN P
        ...
        if (processMatrix(11,1) .eq. 1 ) then
             ...
             call wqm( &
               !configuration
                  ...
                  parameterset_SSA(185*6+1:185*10),                                              &
             ...
             WQM_nutrient(tt,1, 1:2) = L11_concMod(184,1:2)
             WQM_nutrient(tt,1, 3) = L11_concMod(184,1)
        ...
        if (tt .gt. 720) then
          L1_allDischarge(1,tt-720) = L11_concMod(84,1)
          L1_allDischarge(2,tt-720) = L11_concMod(130,1)
          L1_allDischarge(3,tt-720) = L11_concMod(137,1)
          L1_allDischarge(4,tt-720) = L11_concMod(184,1)
        end if
